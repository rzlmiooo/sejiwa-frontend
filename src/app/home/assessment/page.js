...
export default function Ass() {
    ...
    return (    
        <div className="flex-1 h-screen w-max overflow-auto">
            {/* Main content */}
            <main className="flex flex-col overflow-x-auto min-h-screen p-8 bg-gray-100 dark:bg-gray-900 text-black dark:text-white">
                <div className='ml-4 sm:ml-18 flex flex-col fixed z-10'>
                    <h1 className="text-2xl font-bold">Assessment</h1>
                    <h2 className="text-sm/6 font-medium">Isi survei dibawah sesuai dengan kondisimu sekarang.</h2>
                </div>
                {/* <!-- Table Section --> */}
                <div class="mt-15 px-2 py-10 lg:px-8 lg:py-14 mx-auto z-50 bg-gray-100 dark:bg-gray-900 text-black dark:text-white">
                    {/* <!-- Card --> */}
                    <div class="flex flex-col">
                        <div class="-m-1.5 p-1.5 inline-block align-middle">
                            <div class="min-w-full sm:min-w-max bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700">
                                {/* <!-- Header --> */}
                                                ...
                                                <tr key={q.id} className="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <select
                                                            ...
                                                            className="border rounded px-0 py-1 text-sm dark:bg-neutral-800 dark:text-white">
                                                            <option value="">-</option>
