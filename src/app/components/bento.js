...
export default function Bento() {
    return (
      ...
      {/* <!-- Bento 1 --> */}
      <Link href="/home/assessment" className="bg-white rounded-t-4xl sm:rounded-l-4xl shadow-md p-10 flex flex-col items-start space-y-2 border-t-2 border-t-blue-200 hover:scale-101">
      ...
      <Link href="/home/recommendation" className="bg-white shadow-md p-10 flex flex-col items-start space-y-2 border-t-2 border-t-blue-200 hover:scale-101">
        ...
        {/* <!-- Bento 3 --> */}
      <Link href="/home/chat" className="bg-white rounded-b-4xl sm:rounded-r-4xl shadow-md p-10 flex flex-col items-start space-y-2 border-t-2 border-t-blue-200 hover:scale-101">
